...
export function ExportPanel({
  ...
  return (
    <section className="rounded-lg border border-[#263244] bg-[#0B0F19] p-4" aria-label="Export">
      ...
      {message ? (
        <p aria-live="polite" className="mt-3 rounded-lg border border-[#263244] bg-[#141A26] p-3 text-sm text-[#CBD5E1]">
          {message}
        </p>
      ) : null}
    </section>
